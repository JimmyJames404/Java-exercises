...
public class direcciones_ip {
    ...
    public static int[] bina(String[] str)
    {
        ...
        // Convertir primer numero a binario
        for (i = 0; i <= 7; i++)
        {
            rem = a % 2;
            st.push(rem);
        ...
        // obtener primer octecto
        for (i = 0; i <= 7; i++) {
            re[i] = st.pop();
        }
         
        // Segundo numero a binario
        for (i = 8; i <= 15; i++) {
            rem = b % 2;
            st.push(rem);
            b = b / 2;
    ...
    // Lo siguiente obtiene  la clase segun los rangos
    ...
    // CConvertir direccion binaria a decimal
    ...
    public static void main(String args[])
    {
        ...
        System.out.println("Introduce direccion IP con mascara");
        System.out.println("Ejemplo:\t 192.168.1.1/24");
        Scanner sc = new Scanner(System.in);
        String ipr = sc.nextLine(); //Siempre ingresar un formato asi sino se rompe todo(x.y.z.t/n)
        ...
        // Printing in dotted decimal format
        System.out.println("Dirrecion broadcast : "
                     + br[0] + "." + br[1] + "." + br[2] + "." + br[3]);
    }
}
